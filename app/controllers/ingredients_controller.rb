class IngredientsController < ApplicationController
    ...
    def create
        ...
        recipe.update!(calories: food[:calories]*params[:serving_size], fats: food[:fats]*params[:serving_size], carbs: food[:carbs]*params[:serving_size], added_sugars: food[:added_sugars]*params[:serving_size], protein: food[:protein]*params[:serving_size])
        byebug
