    ...
    <div className="App">
      <Router>
        ...
        <Routes>
          ...
          <Route exact path='/today' element={<Today users={users} foods={foods} categories={categories} meal={meal} setMeal={setMeal}/>}/>
          <Route exact path='/foodlist' element={<FoodList foods={foods} meal={meal} categories={categories}/>}/>
        </Routes>
      </Router>
    </div>
  );
