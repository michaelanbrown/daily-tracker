...
d1 = Category.create(date: "Today", food_id: f1.id, user_id: u1.id)
d2 = Category.create(date: "Today", food_id: f2.id, user_id: u1.id)
d3 = Category.create(date: "Today", food_id: f3.id, user_id: u1.id)